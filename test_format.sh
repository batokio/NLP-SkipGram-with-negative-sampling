...
REPORT=report.pdf
NLINES=20000 # number of lines, play around with increasing numbers
...
python skipGram.py --model mymodel --text $TRAINDATA

echo "INFO: running testing"
python skipGram.py --test --model mymodel/sg.zip --text $TESTDATA > $RESULTFILE
